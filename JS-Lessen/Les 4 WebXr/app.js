...
minecraftModel.setScale(0.5, 0.1, 0.1);
...
// create some text
const testText = new Text('Thicc steve');
...
// create a 360 image
const image360 = new Sky('http://l3apq3bncl82o596k2d1ydn1-wpengine.netdna-ssl.com/wp-content/uploads/2016/09/360-redull-storytelling-vr.png');
